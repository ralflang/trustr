...
Further information on Trustr and the latest version can be obtained at
...
The following documentation is available in the Trustr distribution:
...
:`doc/UPGRADING`_:  Pointers on upgrading from previous Trustr versions


Installation
============

Instructions for installing Trustr can be found in the file INSTALL_ in the
``doc/`` directory of the Trustr distribution.
